import project1 from '/src/projects/Projects-1.png'
import project2 from '/src/projects/Projects-2.png'
import project3 from '/src/projects/Project-3.png'
import project4 from '/src/projects/Project-4.jpg'
...
- Conducted rigorous testing to ensure cross-browser compatibility and optimal performance.`,
    ...
    company: "VanSuya Food Corps",
    description: `Inventory Management Systems. Develop systems to manage inventory effectively in automating inventory tracking, reduce waste, and integrate with ordering and POS systems.
- Created a Website and Digital Presence. Develop and maintain the restaurant's website, the website is user-friendly, includes online ordering capabilities, and integrates with social media and marketing tools.`,
    technologies: ["AWS System", "Algorithms", "React Native", "Data Entry"],
  },
    {
    year: "May 2023 - Aug 2023",
    role: "Intern",
    company: "Hybis Brand",
    description: `Resolved 15+ bugs in microservices by communicating with stakeholders, finding root causes, and developing fixes. Developing using Javascript
- Analyzing customer feedback data to identify trends and areas for improvement. Assisting in the development of a mobile app for customer loyalty programs..`,
    technologies: ["JavaScript", "HTML/CSS", "React", "Data Entry"],
  },
  {
    year: "Apr 2021 - Sept 2021",
